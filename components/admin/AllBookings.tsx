...
const AllBookings = ({ data }: Props) => {
  ...
  useEffect(() => {
    if (error && "data" in error) {
      toast.error((error.data as { errMessage?: string })?.errMessage || 'An error occurred');
    }
        ...
        actions: (
          <>
            ...
            <button
              ...
              disabled={isLoading}
              onClick={() => booking?._id && typeof booking._id === 'string' ? deleteBookingHandler(booking._id) : null}
            >
